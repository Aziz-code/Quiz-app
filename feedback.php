...
<div class="col-md-6 panel my-5" style="background-color:#EAF0F1 min-height:430px;">
<h2 align="center" style="font-family: 'Oranienbaum', serif; color:000; ">FEEDBACK</h2>
...
<div class="row">
<div class="col-md-3"><b>MESSAGE:</b></div>
<div class="col-md-9">
<div class="form-group"> 
...
<input type="submit" name="submit" value="Send Feedback" class="btns" style="background-color: #243B55; color: #EAF0F1;" >
</font>
</div>
    </div>
    </div>
