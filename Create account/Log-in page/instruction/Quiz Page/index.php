...
<body>
        ...
        <div class="questionBox" id="app">
            ...
            <transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
                ...
                <div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
                    ...
                    <header>
                        <h1 class="title is-6">Online quiz system</h1>
                        <!--progress-->
                        <div class="countdown">
                            <h1 id="count">59</h1>
                            <h1 id="min">59</h1>:
                ...
                <!--quizCompletedResult-->
                <div v-if="questionIndex >= quiz.questions.length" v-bind:key="questionIndex" class="quizCompleted has-text-centered" id="result">
                    ...
                    <h4>Total no of questions:{{quiz.questions.length}}</h4>
                    <h4>Total no. of correct questions:{{score()}}</h4>
                    <h4>Total no of incorrect questions:{{10-score()}}</h4>
                    <p class="subtitle">
    ...
    <!--<script  src="./script.js"></script>-->
       ...
       <?php
        ...
        $s = "SELECT Question_no, Question, option1, option2, option3, option4, correct_option1, correct_option2, correct_option3, correct_option4 FROM Subject2";
                ...
                if(counter==0)
                    {
                        ...
                        id.innerHTML=counter;
                        minutes--;
                        id=document.getElementById("min");
                        id.innerHTML=minutes;
                    }
            },1000);
