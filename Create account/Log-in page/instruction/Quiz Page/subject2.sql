...
INSERT INTO Subject2 VALUES(12,"Which of the following statement is false?","A process is a collection of related tasks that transforms a set of inputs to the set of output","A design notation is a symbolic representational system","A design heuristic is a rule proceeding guidance","with guarantee for achieving some end",0,1,0,0);
...
INSERT INTO Subject2 VALUES(15,"What is the solution for Structural design?","The specification model following data flow diagram","Procedures represented as bubbles","Specification model is structure chart showing procedure calling hierarchy and flow of data in and out of procedures","Emphasizing procedural decomposition",0,0,1,0);

INSERT INTO Subject2 VALUES(16, "Which of these are followed by the latest versions of structural design?","More detailed and flexible processes","Regular Notations","Wide support by CASE","More detailed and flexible processes",0,0,0,1);
